      ...
      <div className={styles.footerMain}>
        <div className={styles.footerGrid}>
          ...
          <div className={`${styles.footerCol} ${styles.brandCol}`} data-reveal>
            ...
            <div className={styles.contactInfo}>
              <a href={`mailto:${CONTACTS.email.general}`} className={styles.contactLink}>
        ...
        <div className={styles.footerBottom} data-reveal>
          ...
          <div className={styles.socialIcons}>
            ...
            <a href={CONTACTS.social.twitter} target="_blank" rel="noopener noreferrer" aria-label="Twitter / X">
          ...
          <p className={styles.tagline}>Aapka Bharosa, Humari Pahechan</p>
        </div>
      </div>
    </footer>
  );
